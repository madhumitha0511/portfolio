      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 grid lg:grid-cols-2 gap-12 items-center relative z-10">
        ...
        >
          ...
          >
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="px-8 py-4 bg-[color:var(--color-primary)] text-white font-semibold rounded-xl shadow-lg hover:shadow-2xl transition-all"
            >
              Projects
            </motion.a>
            ...
            {owner.linkedin_url && (
              <motion.a
                ...
                whileHover={{ scale: 1.05, y: -2 }}
                whileTap={{ scale: 0.95 }}
                className="px-8 py-4 border-2 border-[color:var(--color-border)] text-[color:var(--color-text)] font-semibold rounded-xl hover:border-[color:var(--color-primary)] hover:text-[color:var(--color-primary)] transition-all"
              >
                LinkedIn
              </motion.a>
            )}
        ...
        >
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="w-[400px] h-[400px] md:w-[500px] md:h-[500px] rounded-full bg-gradient-to-br from-[color:var(--color-primary)] to-[color:var(--color-primary)]/40 opacity-20 blur-2xl" />
          </div>
          ...
          >
            <img
              src={owner.profile_image_url || "/profile.png"}
